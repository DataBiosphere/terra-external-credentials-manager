...
//        // For security reasons, we generally don't want to include the user's invalid (and
// potentially
//        // malicious) input in the error response, which also means we don't include the full
// exception.
...
//        ApiErrorReport errorReport =
//                new
// ApiErrorReport().message(ex.getMessage()).statusCode(statusCode.value()).causes(causes);
