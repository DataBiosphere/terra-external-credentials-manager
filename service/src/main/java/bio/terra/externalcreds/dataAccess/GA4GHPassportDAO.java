...
public class GA4GHPassportDAO {
  ...
  public boolean deletePassport(int linkedAccountId) {
    ...
    String query = "DELETE FROM ga4gh_passport p WHERE p.linked_account_id :linkedAccountId";
  ...
  public GA4GHPassport getPassport(int linkedAccountId) {
    SqlParameterSource namedParameters =
        new MapSqlParameterSource().addValue("linkedAccountId", linkedAccountId);
    String query = "SELECT * FROM ga4gh_passport p WHERE p.linked_account_id :linkedAccountId";
