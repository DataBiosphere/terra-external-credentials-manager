...
public class PassportService {
  ...
  public boolean validatePassport(
      String passportJwtString, List<OneOfVisaCriteriaInterfaceItems> criteria) {
  ...
  private Optional<VisaComparator> getVisaComparator(OneOfVisaCriteriaInterfaceItems criterion) {
